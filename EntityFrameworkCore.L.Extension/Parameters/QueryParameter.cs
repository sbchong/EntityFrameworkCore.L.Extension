...
namespace EntityFrameworkCore.L.Extension.Parameters
{
    public  class QueryParameter<TEntity, TKey> :  INotifyPropertyChanged
    {
        ...
        //{
        //    get => _orderBy;
        //    set => _orderBy = value ?? "Id";// ?? nameof(IEntity.Id);
        //}
